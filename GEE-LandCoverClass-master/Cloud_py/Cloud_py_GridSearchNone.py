...
rskf = RepeatedStratifiedKFold(n_splits=2, n_repeats=4, random_state =1)
...
#df['n_features']=pd.to_numeric(df['param_reduce_dim__n_components'])#.fillna(df['param_reduce_dim__k'])
df['n_features'] = 'NaN'
